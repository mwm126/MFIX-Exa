...
The following inputs must be preceded by "amr" and control frequency and naming of plotfile and checkpoint generation
...
The following inputs must be preceded by "amr" and determine which variables are written in a plotfile.
